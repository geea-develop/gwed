...
@section('content')
    ...
    <div class="container">
        ...
        <div class="jumbotron bg-light">
            ...
            <h2>Welcome to our {{$category}}! Please feel free to browse </h2>
        </div>
            ...
            <div class="card text-left">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h5 class="card-title">{{ $product->title }} <small><a href="{{ url('/shop/category/' . $product->category) }}" title="{{ $product->category }}">{{ $product->category }}</a></small></h5>
                        </div>
                    </div>
