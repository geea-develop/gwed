...
Run with in console `karma start`
Requires `karma-cli`
 
Write your Tests within Your JS “tests” directory
...
Run while DB is empty. (drop all collections before run)

Run with in console `php vendor/bin/phpunit`

Write your Tests within Your tests directory